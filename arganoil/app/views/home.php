...
<div class="row" id="row1">
        <div class="col-md-3">
        <div style="width:50%;margin:auto"><img src="app/views/assets/images/img-home/drop.png" alt="Argan oil,argan oil benefits ,organic argan oil ,pure argan oil ,Moroccan argan oil, argan oil for hair ,argan oil for skin ,best argan oil products ,buy argan oil online ,argan oil uses, argan oil cosmetics, argan oil extraction process, cold-pressed argan oil, argan oil moisturizer ,natural beauty products, argan oil anti-aging, Argan oil benefits for skin, prickly pear oil,bulk, beauty products, beauty brand,beauty products online,argan oil of morocco,argan oil for face,argan oil price, 100%pure" class="img-fluid w-100">
            </div>
            <h5 >7000</h5>
        ...
        <div style="width:50%;margin:auto"><img src="app/views/assets/images/img-home/heart.png" alt="Argan oil,argan oil benefits ,organic argan oil ,pure argan oil ,Moroccan argan oil, argan oil for hair ,argan oil for skin ,best argan oil products ,buy argan oil online ,argan oil uses, argan oil cosmetics, argan oil extraction process, cold-pressed argan oil, argan oil moisturizer ,natural beauty products, argan oil anti-aging, Argan oil benefits for skin, prickly pear oil,bulk, beauty products, beauty brand,beauty products online,argan oil of morocco,argan oil for face,argan oil price, 100%pure" class="img-fluid w-100">
            ...
            <h5>100</h5>
            <p data-i18n="SATISFACTIONGUARANTEED">100% SATISFACTION GUARANTEED, EVERY SINGLE CUSTOMER WAS PLEASED.</p><br><br>
        </div>
        <div class="col-md-3">
        <div style="width:50%;margin:auto"><img src="app/views/assets/images/img-home/check.png" alt="Argan oil,argan oil benefits ,organic argan oil ,pure argan oil ,Moroccan argan oil, argan oil for hair ,argan oil for skin ,best argan oil products ,buy argan oil online ,argan oil uses, argan oil cosmetics, argan oil extraction process, cold-pressed argan oil, argan oil moisturizer ,natural beauty products, argan oil anti-aging, Argan oil benefits for skin, prickly pear oil,bulk, beauty products, beauty brand,beauty products online,argan oil of morocco,argan oil for face,argan oil price, 100%pure" class="img-fluid w-100">
            </div>
            <h5>80</h5>
            <p data-i18n="OURCUSTOMERS">80% OF OUR CUSTOMERS RETURN FOR MORE ORDERS, THE OTHER 20% WILL RE ORDER</p><br><br>
        </div>
        <div class="col-md-3">
        <div style="width:50%;margin:auto"><img src="app/views/assets/images/img-home/gift.png" alt="Argan oil,argan oil benefits ,organic argan oil ,pure argan oil ,Moroccan argan oil, argan oil for hair ,argan oil for skin ,best argan oil products ,buy argan oil online ,argan oil uses, argan oil cosmetics, argan oil extraction process, cold-pressed argan oil, argan oil moisturizer ,natural beauty products, argan oil anti-aging, Argan oil benefits for skin, prickly pear oil,bulk, beauty products, beauty brand,beauty products online,argan oil of morocco,argan oil for face,argan oil price, 100%pure" class="img-fluid w-100">
            </div>
            <h5>170</h5>
            <p data-i18n="FAMILIES">OVER 170 WOMEN & FAMILIES HELPED AND ASSISTED BY OUR COOPERATIVE IN MORROCCO</p><br><br>
        </div>
    </div>
</div>
</div>
...
<button id="whatsappButton">
        <a href="https://api.whatsapp.com/send?phone=+212 524 335 449" class="fab fa-whatsapp"> </a>
    ...
    <script>
        document.getElementById("whatsappButton").addEventListener("click", function(event) {
            ...
            var phoneNumber = "+212 524 335 4490";
