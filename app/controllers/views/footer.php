<!DOCTYPE html>
    ...
    <footer class="footer">
        ...
        <div class="d-flex justify-content-between">
            ...
            <pre style="color:#fff;">N ° 200 Lot El Massar, Route de Safi<br>40 100 Marrakech MAROC</pre> 
            ...
            <div class="sect" style="justify-content:center;text-align:center">
        ...
        <div style="width:100%;margin-bottom: 0;text-align:center;">
            <hr>
            <p style="margin-bottom: 0;">&copy; 2023 Your Website. All rights reserved.</p>
        </div>
